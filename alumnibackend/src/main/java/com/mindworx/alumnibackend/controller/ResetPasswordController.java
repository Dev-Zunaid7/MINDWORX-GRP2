...
import com.mindworx.alumnibackend.email.Utility;
...
public class ResetPasswordController {
    ...
    public void sendEmail(String recipientEmail, String link)  throws MessagingException, UnsupportedEncodingException{
        ...
        helper.setFrom("contact@Alumniapp.com", "AlumniApp Support");
    ...
    public String processResetPassword(HttpServletRequest request, Model model) {
        ...
        Mindworxuser mindworxuser = userService.getByResetPasswordToken(token);
        model.addAttribute("title", "Reset your password");
         
        if (mindworxuser == null) {
            model.addAttribute("message", "Invalid Token");
            return "message";
        } else {           
            userService.updatePassword(mindworxuser, password);
