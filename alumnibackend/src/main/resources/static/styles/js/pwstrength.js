...
(function(jQuery) {
    ...
    (function(i18next) {
        ...
        i18n.fallback = {
            wordMinLength: 'Password is too short',
            wordMaxLength: 'Password is too long',
            wordInvalidChar: 'Password contains an invalid character',
            wordOneSpecialChar: 'Password must contain least one special character',
            wordLowercase: 'Password must contain a Lowercase',
            wordUppercase: 'Password must contain a Uppercase',
            wordNotEmail: 'Do not use your email as your password',
            wordOneNumber: 'Password must have a number',
