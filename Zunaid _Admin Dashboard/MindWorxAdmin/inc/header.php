...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>MindWorx User Management</title>
...
if (isset($_GET['action']) && $_GET['action'] == 'logout') {
 ...
 ?>
    ...
    <div class="container">
      ...
      <nav class="#e57200 navbar-expand-md navbar-dark bg-#56575b card-header">
        <a class="navbar-brand" href="index.php"><img src= "logo\Mindworx logo.png" width = 12% , height= 30%></i>MindWorx Admin Dashboard</a>
